...
if __name__ == '__main__':
    ...
    while True:
        sp,sp2 = main(sp, sp2)
        if getKey('LEFT') and ang1<180:
            ang1 = ang1+1
            print("base", ang1)
        elif getKey('RIGHT') and ang1>0:
            ang1 = ang1-1
            print("base", ang1)

        if getKey('2') and ang2<180:
            ang2 = ang2+1
            print("s2", ang2)
        elif getKey('1') and ang2>12:
            ang2 = ang2-1
            print("s2", ang2)

        if getKey('3') and ang3<180:
            ang3 = ang3+1
            print("s3", ang3)
        elif getKey('4') and ang3>0:
            ang3 = ang3-1
            print("s3", ang3)

        if getKey('6') and ang4<180:
            ang4 = ang4+1
            print("s4", ang4)
        elif getKey('5') and ang4>0:
            ang4 = ang4-1
            print("s4", ang4)

        if getKey('8') and ang5<180:
            ang5 = ang5+1
            print("spin", ang5)
        elif getKey('7') and ang5>0:
            ang5 = ang5-1
            print("spin", ang5)
        ...
        if getKey('i'):
            print("----------Info-----------")
            print("front motor speed:", sp)
            print("back motor speed:", sp2)
            print("servo1:", ang1)
            print("servo2:", ang2)
            print("servo3:", ang3)
            print("servo4:", ang4)
